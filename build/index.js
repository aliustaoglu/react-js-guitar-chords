...
var openStringLetter = function openStringLetter(note, barre) {
  var letter = note === barre ? '' : 'x';
  return letter;
};

var drawOpenStringNote = function drawOpenStringNote(note, stringNo, barre) {
  var x = (5 - stringNo) * 10 + 2;
  return _react2.default.createElement(
    'text',
    { key: 'openStr ' + stringNo, x: x, y: '10', fill: 'black', fontSize: '12' },
    note < 1 && openStringLetter(note, barre),
    ' '
  );
};

var drawOpenStringNotes = function drawOpenStringNotes(notes) {
  var barre = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : 0;

  return notes.map(function (note, ind) {
...
var drawFretboard = function drawFretboard(frets) {

  return _react2.default.createElement(
    'g',
    null,
    _react2.default.createElement('line', { x1: '5', y1: '12', x2: '55', y2: '12', style: { stroke: 'rgb(0,0,0)', strokeWidth: '2' } }),
...
var lowestFret = function lowestFret(notes) {
  return notes.min();
};

var highestFret = function highestFret(notes) {
  return notes.max();
};

exports.default = {
  openStringLetter: openStringLetter,
  drawOpenStringNote: drawOpenStringNote,
  drawOpenStringNotes: drawOpenStringNotes,
...
var _fret = __webpack_require__(6);
...
var Chord = function (_Component) {
  ...
  _createClass(Chord, [{
    ...
    value: function render() {
      ...
      var notes = this.props.notes.split('').map(function (item) {
        if (item === 'x') return -1;
      ...
      return _react2.default.createElement(
        'svg',
        { xmlns: 'http://www.w3.org/2000/svg', version: '1.1', width: '80', height: '80' },
        _react2.default.createElement(
          'text',
          { x: '60', y: '14', fill: 'black', fontSize: '12', fontStyle: 'italic' },
          this.props.barre === 0 ? '' : this.props.barre + 'fr'
        ),
        _react2.default.createElement(
          'text',
          { x: '20', y: '78', fontSize: '10', fill: 'red' },
          this.props.name
        ),
